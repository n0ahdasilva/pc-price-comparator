...
# Price Comparator - pricescanadacomputers.py
# Version 1.0
...
class CanadaComputers(object):
    ...
    def set_product_data(self):    # Filtering specific data about the product from what we got in the getData() function:
        ...
        for url in url_list:    # For each URL in the URL_LIST:
            ...
            product_model = product_model.replace("Part #: ", '', 1)
            product_review_count = product_review_count.replace(' Reviews', '', 1)
